...
public:
    ...
    double fisher_alpha(double mean_y, double mean_x, double fisher_k, ///< Fisher, 1st parameter: dip direction, 2nd: dip angle, 3rd: fisher constant,
                                            ...
                                            double min_dip_ang, double max_dip_ang)
{
    ...
    return dip_dir1 + (dip_ang1 - dip_ang1);
}
                                           ...
                                           double min_dip_ang, double max_dip_ang)
{
    ...
    return dip_ang1 + (dip_dir1 - dip_dir1);
}
//--------------------------------------
